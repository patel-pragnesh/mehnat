...
class GeofencebycdnModule : public titanium::Proxy
{
public:
	explicit GeofencebycdnModule();
...
private:
	...
	// Methods -----------------------------------------------------------
	static void checkEnterOrExitFencing(const v8::FunctionCallbackInfo<v8::Value>&);
	static void drawPolygon(const v8::FunctionCallbackInfo<v8::Value>&);
